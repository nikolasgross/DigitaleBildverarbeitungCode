...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint (filepath=os.path.join(cwd,'models/DNN_UMAP_9.h5'),
...
marvin_reloaded = tf.keras.models.load_model('models/DNN_UMAP_9.h5')
